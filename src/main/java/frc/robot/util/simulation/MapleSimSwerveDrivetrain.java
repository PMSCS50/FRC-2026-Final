...
public class MapleSimSwerveDrivetrain {
    ...
    public final SwerveDriveSimulation mapleSimDrive;
        private CommandSwerveDrivetrain ctreDrivetrain;
        ...
        DriveTrainSimulationConfig simulationConfig = DriveTrainSimulationConfig.Default()
                ...
                .withSwerveModule(new SwerveModuleSimulationConfig(
                        ...
                        wheelCOF));
        mapleSimDrive = new SwerveDriveSimulation(simulationConfig, new Pose2d(3.0, 2.0, Rotation2d.fromDegrees(90)));
     ...
     */
    public void update() {
        // Run MapleSim physics
        SimulatedArena.getInstance().simulationPeriodic();

        // Get MapleSim outputs
        ...
        pigeonSim.setRawYaw(pose.getRotation().getMeasure());
        pigeonSim.setAngularVelocityZ(RadiansPerSecond.of(speeds.omegaRadiansPerSecond));

        // Sync CTRE odometry with MapleSim
        var simState = ctreDrivetrain.getState();
        simState.Pose = pose;
        simState.Speeds = speeds;

        // DO NOT sync module states — MapleSim Java API does not expose them
    }
