...
/*
    COPIED FROM PATHPLANNERLIB. 
    ALLOWS FOR PATHFINDING TO BE TESTED IN ADVANTAGEKIT WITHOUT HAVING TO WORRY ABOUT LOGGING BREAKING THE PATHFINDER.
    FOR MORE CONTEXT GO TO Pathfinder.java
*/
