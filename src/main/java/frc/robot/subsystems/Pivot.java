...
public class Pivot extends SubsystemBase {
    ...
    public Pivot() {
        ...
        pivotMotorConfig.closedLoop
                ...
                .pid(.4, .4, 0) // .05,0,0 works with .4, .4
                .outputRange(-.3, .3)
                .positionWrappingEnabled(false)
                .feedForward
                .kCos(0.15)
                .kCosRatio(0.375 / IntakeConstants.kPivotSetpointB); // 0.375 is the ratio of the max torque to the torque at the bottom position
