    ...
    return Commands.run(
        () -> {
          ...
          ChassisSpeeds speeds =
              new ChassisSpeeds(
                  linearVelocity.getX() * Constants.DriveConstants.MaxSpeed,
                  linearVelocity.getY() * Constants.DriveConstants.MaxSpeed,
                  omega * Constants.DriveConstants.MaxAngularRate);
          boolean isFlipped =
